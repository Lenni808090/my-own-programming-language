...
export default class Parser {
  ...
  private parse_conditional_comparission(): Expr {
    let left = this.parse_additive_expr();

    while (
      this.at().type == TokenType.GreaterThen ||
      this.at().type == TokenType.GreaterThenEquals ||
      this.at().type == TokenType.LessThen ||
      this.at().type == TokenType.LessThenEquals ||
  ...
  private parse_object_expr(): Expr {
    ...
    if (this.at().type !== TokenType.OpenBrace) {
      return this.parse_conditional_comparission();
    }
