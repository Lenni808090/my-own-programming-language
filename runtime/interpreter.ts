...
import { BinaryExpr, NumericLiteral, Stmt, Program } from "../frontend/ast.ts";
...
function eval_programm(program: Program): RuntimeVal {
...
export function evaluate(astNode: Stmt): RuntimeVal {
  switch (astNode.kind) {
    ...
    case "Program":
      return eval_programm(astNode as Program);
    default:
      console.error(
